...
Sensor: RPi 4 Model B (4GB) ←→ Wi-Fi 802.11ac ←→ Local Sagemcom Broadband SAS Router (version 3.0_CU) ←→ Edge: RPI 5 Model B (4GB) ←→ Ethernet to ISP ←→ Cloud: Oracle Cloud VM (_or_ local RPI 5 Model B (4GB))
